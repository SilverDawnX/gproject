...
public class PermissionServiceImpl implements PermissionService {
    ...
    public Map<Long, Set<Long>> getUserRoleIdMapByUserIds(Collection<Long> userIds) {
        ...
        List<UserRoleDO> userRoles = userRoleMapper.selectListByUserIds(userIds);
        Map<Long, Set<Long>> result = new HashMap<>();
        userRoles.forEach(userRole -> result
                .computeIfAbsent(userRole.getUserId(), key -> new HashSet<>())
